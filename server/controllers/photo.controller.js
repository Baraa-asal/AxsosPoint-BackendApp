...
module.exports.GetPhotoForUser = async (req, res) => {
  Photo.find({ user_id: req.params.id })
  .then((allAvatars) => res.json(allAvatars[0] ))
...
module.exports.Avatar = async (req, res) => {
  ...
  console.log("req.file.avatar", req.file.filename);
  ...
  Promise.all([
    ...
    .then(async () => {
      ...
      console.log("window 37", document.getElementById("myImg"));
      ...
      console.log("detections 52 : ", detections);
